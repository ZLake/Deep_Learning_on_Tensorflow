...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 18 10:16:37 2017

@author: lakezhang
"""
# ==============================================================================
# use bigram as input to LSTM cell, 2 letters as one input
# ==============================================================================
...
# 1 bigram has 2 letters, size squared
vocabulary_size = (len(string.ascii_lowercase) + 1) * (len(string.ascii_lowercase) + 1)  # [a-z] + ' '

# create dictionary to store index and its corresponding bigram
idx2bi = {}
bi2idx = {}
idx = 0
